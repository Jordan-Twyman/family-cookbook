...
export const IngredientForm = () => {
 ...
 <form className="eventForm">
            ...
            <fieldset>
                <div className="form-group ingredientForm">
                    <label htmlFor="name">Ingredient name:</label>
                    <input type="text" id="ingredientName" onChange={handleControlledInputChange} required autoFocus className="form-control"/>
                </div>
            </fieldset>
